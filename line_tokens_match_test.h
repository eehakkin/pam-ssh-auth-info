...
struct {
	...
	{"[abbccc]", {
		...
		{"[[]?(?(a))?(*(b))?(@(ccc))?(+(d))?()[]]", false, true, {2u, MAX(2u * (size_t)UINT_MAX + 6u, UINT_MAX)}},
		{"[[]*(|a)*(|b)*(|c)*(|d)*()[]]", false, true, {2u, MAX(4u * (size_t)UINT_MAX + 2u, UINT_MAX)}},
		{"[[]*(?(a))*(**(b))*(@(c))*(+(d))?()[]]", false, true, {2u, SIZE_MAX}},
		{"[[]@(a)@(bb)@(ccc)@()[]]", false, true, {8u, 8u}},
		{"[[]@(?(a))@(**(b))@(@(ccc))@()[]]", false, true, {5u, SIZE_MAX}},
		{"[[]+(|a)+(|b)+(|c)+(|d)+()[]]", false, true, {2u, MAX(4u * (size_t)UINT_MAX + 2u, UINT_MAX)}},
		{"[[]+(?(|a))+(**(|b))+(@(|c))+(+(|d))+()[]]", false, true, {2u, SIZE_MAX}},
		...
		{"[[]!(???"/* no trigraphs */")[]]", false, true, {2u, SIZE_MAX}},
	...
	{"", {
		...
		{"@(*)", false, true, {0u, SIZE_MAX}},
		{"!(!(*))", false, true, {0u, SIZE_MAX}},
		{"!(??|???|????|?????"/* no trigraphs */")", false, true, {0u, SIZE_MAX}},
		{"*(?)", false, true, {0u, UINT_MAX}},
		{"+(?)+(?)", false, false, {2u, MAX(2u * (size_t)UINT_MAX, UINT_MAX)}},
		...
		{"??*", false, false, {2u, SIZE_MAX}},
		{"!(*)", false, false, {1u, SIZE_MAX}},
		{"!(|?|??|???|????|?????"/* no trigraphs */")", false, false, {1u, SIZE_MAX}},
		{NULL, false, false, {0u, 0u}}
	}},
	/* The first line is empty.
	 */
	...
	{"method\n", {
		...
		{"!(??|???|????|?????"/* no trigraphs */")", false, true, {0u, SIZE_MAX}},
		{"*(?)", false, true, {0u, UINT_MAX}},
		{"+(?)+(?)", false, true, {2u, MAX(2u * (size_t)UINT_MAX, UINT_MAX)}},
		{"* *", false, false, {1u, SIZE_MAX}},
		{"@(* *)", false, false, {1u, SIZE_MAX}},
		...
		{"??*", false, true, {2u, SIZE_MAX}},
		{"!(*)", false, false, {1u, SIZE_MAX}},
		{"!(|?|??|???|????|?????"/* no trigraphs */")", false, true, {1u, SIZE_MAX}},
	...
	{"method key=type abcdef==\n", {
		{"*=*k*=*b*==", false, true, {6u, SIZE_MAX}},
		{"*=*k* *b*==", false, true, {6u, SIZE_MAX}},
		{"*=*k*=*t*=*b*==", false, true, {8u, SIZE_MAX}},
		{"*=*k*=*t* *b*==", false, true, {8u, SIZE_MAX}},
		{"+(?)=+(*k*)=+(*b*)==", false, true, {7u, SIZE_MAX}},
		{"+(?)=+(*k*) +(*b*)==", false, true, {7u, SIZE_MAX}},
		{"+(?)=+(*k*)=+(*t*)=+(*b*)==", false, true, {9u, SIZE_MAX}},
		{"+(?)=+(*k*)=+(*t*) +(*b*)==", false, true, {9u, SIZE_MAX}},
		{NULL, false, false, {0u, 0u}}
	}},
	{"method key=type abc def==\n", {
		{"*=*k*=*b*=*?*e*==", false, true, {9u, SIZE_MAX}},
		{"*=*k*=*b* *?*e*==", false, true, {9u, SIZE_MAX}},
		{"*=*k* *b*=*?*e*==", false, true, {9u, SIZE_MAX}},
		{"*=*k* *b* *?*e*==", false, true, {9u, SIZE_MAX}},
		{"*=*k*=*t*=*?*b*=*e*==", false, true, {11u, SIZE_MAX}},
		{"*=*k*=*t*=*?*b* *e*==", false, true, {11u, SIZE_MAX}},
		{"*=*k*=*t* *?*b*=*e*==", false, true, {11u, SIZE_MAX}},
		{"*=*k*=*t* *?*b* *e*==", false, true, {11u, SIZE_MAX}},
		{"+(?)=+(*k*)=+(*b*)=+(*?*f==|*e)*==", false, true, {9u, SIZE_MAX}},
		{"+(?)=+(*k*)=+(*b*) +(*?*f==|*e)*==", false, true, {9u, SIZE_MAX}},
		{"+(?)=+(*k*) +(*b*)=+(*?*f==|*e)*==", false, true, {9u, SIZE_MAX}},
		{"+(?)=+(*k*) +(*b*) +(*?*f==|*e)*==", false, true, {9u, SIZE_MAX}},
		{"+(?)=+(*k*)=+(*t*)=+(*?*b*)=+(*f==|*e)*==", false, true, {12u, SIZE_MAX}},
		{"+(?)=+(*k*)=+(*t*)=+(*?*b*) +(*f==|*e)*==", false, true, {12u, SIZE_MAX}},
		{"+(?)=+(*k*)=+(*t*) +(*?*b*)=+(*f==|*e)*==", false, true, {12u, SIZE_MAX}},
		{"+(?)=+(*k*)=+(*t*) +(*?*b*) +(*f==|*e)*==", false, true, {12u, SIZE_MAX}},
		{NULL, false, false, {0u, 0u}}
