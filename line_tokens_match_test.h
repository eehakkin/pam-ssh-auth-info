...
struct {
	...
	{"[abbccc]", {
		...
		{"[[]*(|a)*(|b)*(|c)*(|d)*()[]]", true, 2u, MAX(4u * (size_t)UINT_MAX + 2u, UINT_MAX)},
		{"[[]@(a)@(bb)@(ccc)@()[]]", true, 8u, 8u},
		{"[[]+(|a)+(|b)+(|c)+(|d)+()[]]", true, 2u, MAX(4u * (size_t)UINT_MAX + 2u, UINT_MAX)},
		...
		{"[[]?(a)?(b)?(ccc)[]]", false, 2u, 7u},
		{"[[]@(a)@(b)@(ccc)[]]", false, 7u, 7u},
		{"[[]+(|a)+(|b)+(|c)+(d)[]]", false, 3u, MAX(4u * (size_t)UINT_MAX + 2u, UINT_MAX)},
	...
	{"method key-type abcdef==\n", {
		...
		{"* ?", false, 2u, SIZE_MAX},
		{"* ?*", true, 2u, SIZE_MAX},
		{"+(?)=+(?)", true, 3u, MAX(2u * (size_t)UINT_MAX + 1u, UINT_MAX)},
		...
		{"* * ?", false, 3u, SIZE_MAX},
		{"* * ?*", true, 3u, SIZE_MAX},
		{"+(?)=+(?)=+(?)", true, 5u, MAX(3u * (size_t)UINT_MAX + 2u, UINT_MAX)},
